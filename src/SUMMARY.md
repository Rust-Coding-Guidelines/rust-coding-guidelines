...
- [Coding Practice](./safe-guides/coding_practice.md)
    - [Const](./safe-guides/coding_practice/consts.md)
        ...
        - [G.CNS.04 Shouldn't add explicit `'static` lifetime in constant declaration](./safe-guides/coding_practice/consts/G.CNS.04.md)
        - [G.CNS.05 Should use const fn as much as possible](./safe-guides/coding_practice/consts/G.CNS.05.md)
    - [Static Const](./safe-guides/coding_practice/statics.md)
        - [G.STV.01 Shouldn't use `static mut` as global variable directly](./safe-guides/coding_practice/statics/G.STV.01.md)
